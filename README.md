...
If you experiance issues in lab it will help me isolate where the issue lies.  It 'should' als make all my makr and cmake files work straight off without modification.

You will need git installed and possibly other applications as well (git, cmake, )
